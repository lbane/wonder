...
public class ERDirectToWeb extends ERXFrameworkPrincipal {
    ...
    /** logging support */
    public final static Logger log = LoggerFactory.getLogger(ERDirectToWeb.class);
    ...
    public final static org.apache.log4j.Logger debugLog = org.apache.log4j.Logger.getLogger("er.directtoweb.ERD2WDebugEnabled");
...
//  	Configures the system for trace rule firing.
    ...
    private void configureTraceRuleFiringRapidTurnAround() {
        if (trace == null) {
            ...
            trace = org.apache.log4j.Logger.getLogger("er.directtoweb.rules.D2WTraceRuleFiringEnabled");
